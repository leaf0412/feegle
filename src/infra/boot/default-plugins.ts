...
import { createRequirementWorkflowPlugin } from "@plugins/requirement-workflow/requirement-workflow-plugin.js";
...
export function defaultPlugins(deps: DefaultPluginDeps): FeeglePlugin[] {
  return [
    ...
    stockPlugin,
    gitlabFollowPlugin,
    createRequirementWorkflowPlugin({ feegleHome: deps.feegleHome }),
    createFeishuPlugin({
