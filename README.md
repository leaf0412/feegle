...
- `FEISHU_GROUP_REPLY_ALL=true` lets the bot answer every group text message. When it is `false`, mention filtering is enforced if `FEISHU_BOT_OPEN_ID` is configured.
